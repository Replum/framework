...
class ParameterRegistry
{
     ...
     * @param \Replum\WidgetInterface $widget The widget that claims the variable.
     ...
     *
     * @param array $data
     * @return \Replum\ParameterRegistry $this for chaining
     */
     ...
     * @return \Replum\ParameterRegistry $this for chaining
     */
    public function unregister(\Replum\WidgetInterface $widget)
    {
